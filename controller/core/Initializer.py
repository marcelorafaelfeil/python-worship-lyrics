...
from controller.core import Core, ApplicationContext, WebSocketHandler, HttpHandler, SettingsHandler
from view.screens.lyrics.NewLyricScreen import NewLyricScreen
from services.LyricsService import LyricsService
from view.screens.preferences import PreferencesScreen
